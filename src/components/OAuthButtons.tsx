...
export default function OAuthButtons() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // If result has error, display it
      if (result?.error) {
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors font-medium text-gray-700"
      >
        {isGoogleLoading ? (
