  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-amber-50 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-amber-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
      </div>
        ...
        <div className="w-full max-w-6xl">
          ...
          <div className="backdrop-blur-sm bg-white/90 rounded-3xl shadow-2xl border border-white/60 overflow-hidden">
            <div className="grid lg:grid-cols-2">
              {/* Left Side - Branding */}
              <div className="hidden lg:flex relative bg-gradient-to-br from-red-600 via-orange-600 to-amber-600 p-12 items-center justify-center overflow-hidden">
                {/* Decorative Elements */}
              ...
              <div className="p-8 sm:p-10 flex flex-col justify-center">
                ...
                <div className="space-y-3 mb-6">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-200 rounded-xl hover:border-red-500 hover:shadow-md disabled:bg-gray-50 disabled:cursor-not-allowed transition-all font-semibold text-gray-700"
                  >
                    {isGoogleLoading ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-start gap-2.5 bg-red-50 rounded-xl p-3">
                    <input
                      ...
                      type="checkbox"
                      required
                      className="mt-0.5 w-4 h-4 text-red-600 focus:ring-red-600 border-gray-300 rounded"
                    />
                    <label
                      htmlFor="terms"
                ...
                <div className="lg:hidden mt-6 pt-5 border-t border-gray-200">
                  <div className="grid grid-cols-3 gap-3 text-center">
                    <div className="bg-gradient-to-br from-red-50 to-orange-100 rounded-xl p-3">
                      <div className="text-xl font-black text-red-600 mb-0.5">
                        50+
                      </div>
